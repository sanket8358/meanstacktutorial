...
module.exports = function(app, passport) {
    ...
    passport.use(new FacebookStrategy({
            clientID: '310132302707777', // Replace with your Facebook Developer App client ID
            clientSecret: '2e94e77add384b6e2b2029947c827262', // Replace with your Facebook Developer client secret
            callbackURL: "https://stormy-mountain-18226.herokuapp.com/auth/facebook/callback", // Replace with your Facebook Developer App callback URL
    ...
    passport.use(new TwitterStrategy({
            consumerKey: 'XXXXXXXXXXXXXXXXXXXX', // Replace with your Twitter Developer App consumer key
            consumerSecret: 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', // Replace with your Twitter Developer App consumer secret
            callbackURL: "https://stormy-mountain-18226.herokuapp.com/auth/twitter/callback", // Replace with your Twitter Developer App callback URL
    ...
    passport.use(new GoogleStrategy({
            clientID: 'XXXXXXXXX-XXXXXXXXXXXXXXXXXXXXXXXXXXX.apps.googleusercontent.com', // Replace with your Google Developer App client ID
            clientSecret: 'XXXXXXXXXXXXXXXXXXXXXXXX', // Replace with your Google Developer App client ID
            callbackURL: "https://stormy-mountain-18226.herokuapp.com/auth/google/callback" // Replace with your Google Developer App callback URL
        },
        function(accessToken, refreshToken, profile, done) {
            User.findOne({ email: profile.emails[0].value }).select('username active password email').exec(function(err, user) {
                if (err) done(err);
