...
module.exports = function(router) {
    ...
    var client = nodemailer.createTransport({
        service: 'Zoho',
        auth: {
            user: 'usermanagement@zoho.com', // Your email address
            pass: 'XXXXXXXXXXXX' // Your password
        },
        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    var email = {
                        from: 'User Management Team <usermanagement@zoho.com>',
                        to: [user.email, 'rajfullara2474@gmail.com'],
                        subject: 'Your Activation Link',
                        text: 'Hello ' + user.name + ', thank you for registering at localhost.com. Please click on the following link to complete your activation: https://stormy-mountain-18226.herokuapp.com/activate/' + user.temporarytoken,
                        html: 'Hello<strong> ' + user.name + '</strong>,<br><br>Thank you for registering at localhost.com. Please click on the link below to complete your activation:<br><br><a href="https://stormy-mountain-18226.herokuapp.com/activate/' + user.temporarytoken + '">https://stormy-mountain-18226.herokuapp.com/activate/</a>'
                    };
                ...
                user.save(function(err) {
                    if (err) {
                        ...
                        var email = {
                            ...
                            html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently requested a new account activation link. Please click on the link below to complete your activation:<br><br><a href="https://stormy-mountain-18226.herokuapp.com/activate/' + user.temporarytoken + '">https://stormy-mountain-18226.herokuapp.com/activate/</a>'
                        };
        ...
        User.findOne({ email: req.params.email }).select('email name username').exec(function(err, user) {
            if (err) {
                ...
                if (!user) {
                    ...
                    var email = {
                        from: 'Localhost Staff, rajfullara2474@gmail.com',
                        to: user.email,
                    ...
                    user.save(function(err) {
                        if (err) {
                            ...
                            var email = {
                                ...
                                text: 'Hello ' + user.name + ', You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="https://stormy-mountain-18226.herokuapp.com/reset/' + user.resettoken,
                                html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="https://stormy-mountain-18226.herokuapp.com/reset/' + user.resettoken + '">https://stormy-mountain-18226.herokuapp.com/reset/</a>'
                            };
                            // Function to send e-mail to the user
                            client.sendMail(email, function(err, info) {
                                if (err) {
